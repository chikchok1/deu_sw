...
class LoginControllerTest {
    ...
    * 사용자에게 오류 메시지 "서버와 연결할 수 없습니다"를 출력해야 한다.
    */
    @Test
    ...
    /**
     * [테스트 목적]
    *  아이디와 비밀번호 입력 칸이 비어 있을 때,
    * 서버에 연결을 시도하지만 실패 메시지를 출력해야 한다.
    */
    @Test
    ...
    */
    ...
    /**
    * [테스트 목적]
    * 서버 연결 실패 상황에서는 세션(Session)에 사용자 ID와 이름이 저장되지 않아야 한다.
    */
    @Test
    ...
    /**
    * [테스트 목적]
    * 로그인 실패 시 view.dispose()가 호출되지 않아야 한다 (즉, 화면 전환이 없어야 함).
    */
    @Test
